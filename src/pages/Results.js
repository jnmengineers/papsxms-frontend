...
function Results() {
    ...
    const [filterClassStream, setFilterClassStream] = useState(null);
    ...
    const handleSelectClass = (cls) => {
        ...
        setFilterClassStream(cls.stream || null);
           ...
           <Navbar rightContent={
            ...
            <div style={styles.content}>
                ...
                {step === 3 && (
                    <div>
                        <div style={styles.stepHeader}>
                            <button onClick={() => { setStep(2); setSearched(false); setPendingChanges({}); setFilterClassStream(null); }} style={styles.backBtn}>
                                ← Back to Classes
                            </button>
